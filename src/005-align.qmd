...
theory, defines autonomy as \"the capacity to reflect upon and endorse
...
that \"values are crucial in setting priorities and determining
desirable outcomes\" [@bostrom2014superintelligence]. This alignment of
...
Russell, an AI researcher and advocate for human-compatible AI, notes
that \"embedding human values into AI systems is critical to ensure that
these systems act in beneficial and ethical ways\" [@russell2019human].
AI systems can make decisions that reflect societal expectations and
ethical considerations by integrating values such as fairness, justice,
and well-being.
...
emphasizes that \"AI systems must be designed to respect and uphold
human values to function ethically and effectively\"
[@floridi2011ethics].
...
uphold moral duties and respect human dignity" [@floridi_ethics_2011].
...
well-being" [@floridi_ethics_2011]. By focusing on the character and
...
and virtues" [@floridi_ethics_2011].
...
reinforced by the infamous Tuskegee syphilis study [@tuskegee], which,
for decades, misled its participants and withheld treatment,
highlighting the need for moral governance in scientific inquiry. The
Belmont Report [@belmont] marked a turning point, articulating the
...
simple rules or objectives" [@bostrom_superintelligence_2014].
...
[@russell_human_2019]. Different stakeholders may also have conflicting
...
feedback, discussed in the next section. However, humans are
evolutionarily endowed to pay attention to the same things and have the
same frames of reference. AI systems, on the other hand, aren't biased
in the same way, leading to a kind of underdetermination of actions by
language [@quine_word_1960].
...
that a single scalar reward isn't
...
human well-being" [@friedman_value_2008]. Another strategy is
participatory design, which engages stakeholders in the design process
...
<figure id="fig:ethics">
<p><img src="Figures/hendrycks_fig6.png" style="width:75.0%"
alt="image" /> <span id="fig:ethics" data-label="fig:ethics"></span></p>
<figcaption>Learned utility values from <span class="citation"
data-cites="hendrycks_aligning_2021"></span>.</figcaption>
</figure>
...
<figure id="fig:delphi">
<p><img src="Figures/jiang_machines_2022_fig1.png
    " style="width:75.0%" alt="image" /> <span id="fig:delphi"
data-label="fig:delphi"></span></p>
<figcaption>An overview of <span class="citation"
data-cites="jiang_delphi_2021"></span>.</figcaption>
</figure>
...
scenarios like those in Fig. [1.3](#fig:jiminy){reference-type="ref"
reference="fig:jiminy"}. These games offer limited options, and the goal
...
<figure id="fig:jiminy">
<p><img src="Figures/hendrycks_fig1.png" style="width:75.0%"
alt="image" /> <span id="fig:jiminy" data-label="fig:jiminy"></span></p>
<figcaption>An example scenario from <span class="citation"
data-cites="hendrycks_what_2021"></span>.</figcaption>
</figure>
...
Value alignment involves a system correctly learning and adopting the
...
[1.6](#fig:toy){reference-type="ref" reference="fig:toy"} shows the
...
which is reflected in the ARP (hatched region of Figure
[1.6](#fig:toy){reference-type="ref" reference="fig:toy"}b).
...
Figure [1.7](#fig:island){reference-type="ref" reference="fig:island"}a
...
verification. Figures [1.7](#fig:island){reference-type="ref"
reference="fig:island"}b and [1.7](#fig:island){reference-type="ref"
reference="fig:island"}c show two pairwise preference trajectory queries
...
grid world example. Figures [1.7](#fig:island){reference-type="ref"
reference="fig:island"}d, [1.7](#fig:island){reference-type="ref"
reference="fig:island"}e, and [1.7](#fig:island){reference-type="ref"
reference="fig:island"}f show the action queries requested by the
...
linguistic theory (See Figure [1.8](#fig:taxonomy){reference-type="ref"
reference="fig:taxonomy"}).
...
2.  Manually defined groups (stereotypes) that each user is classified
    into.

3.  Automatically learned groups (stereotypes) that each user is
    classified into.
...
interface of the application is presented in
Figure [1.9](#fig:exp-1){reference-type="ref" reference="fig:exp-1"}
...
process. The experimental results are shown in the
Figure [1.10](#fig:exp-2){reference-type="ref" reference="fig:exp-2"}.
...
Figure [1.12](#fig:exp-3){reference-type="ref" reference="fig:exp-3"}
...
concord in UAAVE. Figure
[1.13](#fig:features_dialects){reference-type="ref"
reference="fig:features_dialects"} maps out the presence of various
linguistic features.
...
performance. Figure [1.14](#fig:synthetic_example){reference-type="ref"
reference="fig:synthetic_example"} demonstrates creating a synthetic
...
[1.15](#fig:dada_performance){reference-type="ref"
reference="fig:dada_performance"}.
...
Figure [1.16](#fig:care){reference-type="ref" reference="fig:care"} for
