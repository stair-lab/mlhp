...
In many case, the user might be asked to express their preference in term of comparison between two item $j$ and $j'$, in which the response $Y_{ijj'}$ is one if the item $i$ is preferred and zero otherwise. 
$$
