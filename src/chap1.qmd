...
#### Similar Options (Red-Bus/Blue-Bus) {#sec-red-bus}
...
axes[0].set_title('Samples from GP Prior (RBF kernel, ℓ=1.0)')
axes[0].legend()
...
for ls, color in [(0.3, '#1f77b4'), (1.0, '#ff7f0e'), (3.0, '#2ca02c')]:
    ...
    axes[1].plot(X_grid, sample, color=color, alpha=0.8, label=f'ℓ = {ls}')
