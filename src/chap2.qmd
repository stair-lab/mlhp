...
ax.scatter(X_A[y==1], np.zeros(int(y.sum())) - 2.5, c='green', marker='^', s=50, label='Preferred A')
ax.scatter(X_B[y==0], np.zeros(int((1-y).sum())) - 2.5, c='red', marker='v', s=50, label='Preferred B')
ax.set_xlabel('x')
ax.set_ylabel('r(x)')
ax.set_title(f'GP Preference Learning via Laplace Approximation ({n_comparisons} comparisons)')
