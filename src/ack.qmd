...
<pre class="sourceCode code-with-copy quarto-appendix-bibtex"><code class="sourceCode bibtex">@book{mlhp,
  author    = {Koyejo, Sanmi, Truong, Sang and Haupt, Andreas},
  title     = {{Machine Learning from Comparisons}},
  year      = {2025},
...
<div id="ref-mlhp" class="csl-entry quarto-appendix-citeas">
  S. Koyejo, and S. Truong, and A. Haupt. 2025. Machine Learning from Human Preferences. Stanford University.
</div>
:::
