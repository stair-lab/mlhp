...
<iframe
  src="../slides/chap4.html"
  style="width:90%; height:450px;"
></iframe>
[Fullscreen Slides](../slides/chap4.html){.btn .btn-outline-primary .btn role="button"}
...
**Lecture 4** (Sections 4.5–4.6): Preferential Bayesian Optimization and CIRL
...
5. **Human-Agent Cooperation (CIRL)**: Moving beyond passive oracles to model humans as strategic agents
